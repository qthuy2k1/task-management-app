...
type UserTaskDetailController struct {
	UserTaskDetailRepository *repositories.UserTaskDetailRepository
}

func NewUserTaskDetailController(userTaskDetailRepository *repositories.UserTaskDetailRepository) *UserTaskDetailController {
